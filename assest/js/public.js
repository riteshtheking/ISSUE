...
function switchPage(fr,to) {
	...
	if(to == "#animated-loader-page"){
		...
		$("#attach-response").html('<img class="brz-padding-8" src="'+installation+'/themes/'+theme+'/img/icons/loader.gif" width="40"></img><style>.brz-add-preloader{animation: beatload 1.2s infinite;}</style>');
